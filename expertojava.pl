...
haz_diagnostico(Diagnosis,ListaDeSintomas):-
...
prueba_verdad_de(Diagnosis, Sintoma):- conocido(Sintoma),write('true').
prueba_verdad_de(Diagnosis, Sintoma):- not(conocido(is_false(Sintoma))),write('false').
